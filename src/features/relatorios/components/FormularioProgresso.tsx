        ...
        <form id="form-progresso" className="w-full" onSubmit={handleSubmit}>
                ...
                <div className="flex items-center gap-3 flex-1">
                    ...
                    >
                        ...
                        {listaEtapas.map((etapa) => (
                            <option key={etapa.id_stage || (etapa as any).id} value={etapa.id_stage || (etapa as any).id}>
                                {etapa.name}
                            </option>
                        ))}
                    </select>
            ...
            <div className="flex flex-col xl:flex-row gap-6 mb-6">
                <div className="flex items-center gap-3 flex-[2]">
                    ...
                    <select 
                        name="subetapa" 
                        className={`${inputStyle} w-full ${!formData.etapa ? 'bg-gray-100 cursor-not-allowed' : ''}`} 
                    ...
                    >
                        ...
                        {subetapasFiltradas.map((sub) => (
                            <option key={sub.id_substage} value={sub.id_substage}>
                                {sub.name}
                            </option>
                        ))}
                    </select>
            ...
            <div className="flex items-center gap-3 mb-8 w-full xl:w-1/3">
                ...
                <select name="clima" className={`${inputStyle} w-full`} value={formData.clima} onChange={handleChange}>
                    ...
                    <option value="garoa">Garoa / Chuva Fraca 🌦️</option>
