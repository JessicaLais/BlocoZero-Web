...
import { SessionItem, type SessionItemProps } from "../../../home/components/Session";
...
export function CronogramaSelecao() {
    ...
    // Estados
    const [allWorks, setAllWorks] = useState<SessionItemProps[]>([]); // Guarda todas para filtrar
    const [filteredWorks, setFilteredWorks] = useState<SessionItemProps[]>([]); // Lista exibida
                ...
                <div className="my-6 flex flex-col gap-4 max-h-[282px] overflow-y-scroll">
                    {paginatedWorks.length > 0 ? (
                        paginatedWorks.map((work) => (
                            <div key={work.id_work} onClick={() => handleSelectWork(work.id_work)}>
